...
if ($emaildata) {
	...
	if ($email == "") {
		$error = "<p class='error_echo'>Please type your Upamoja email!</p>";
	}else if ($email_run >= 1) {
		...
		$error = "<p class='succes_echo'>Email successfully changed.</p>";
						// send email
						$msg = "Successfully your Upamoja email has been changed. 
...
<?php echo $error; ?>
	<ul>
		...
		<li style="float: right;">
			...
			<div class="uiaccountstyle">
				<form action="cbinfo_update.php" method="POST">
				<h2><p>Change Upamoja Email</p></h2></br>
					Upamoja Email: </br><input type="email" name="email" id="email" class="placeholder" size="43" value="<?php echo $db_email; ?>"> </br></br>
