	...
	<ul>
		...
		<li style="float: right;">
			...
			<div class="uiaccountstyle">
				...
				Institution: </br><input type="text" name="school" id="school" class="placeholder" size="30" value="<?php echo $db_school; ?>"> </br></br>
				Course: </br><input type="text" name="concentration" id="concentration" class="placeholder" size="30" value="<?php echo $db_concentration; ?>"> </br></br>
