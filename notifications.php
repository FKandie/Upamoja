	...
	<?php include ( "./inc/header.inc.php" ); ?>
		<div style="width: 900px; margin: 52px auto;">
				...
				<div class="homeLeftSideContent">
					<div class="home_cov" style= "background: url(<?php echo $cover_pic; ?>) repeat center center;">
						...
						<div class="homenavemanu">
							<div >
								<div ><a href="index.php">Upamoja</a></div>
			...
			<div style="float: right;">
				 <div class="notificationbox">
				 	<a href="notifications.php"><h2 style="float: left; color: #0B810B;">Upamoja Notification&nbsp;|</h2></a><a href="notification.php"><h2 style="float: left;color: #848684;">&nbsp;Post Notification</h2></a>
		...
		if ($pro_changed_db != $profile_pic_db) {
			...
			$profile_pic = "userdata/profile_pics/".$profile_pic_db;
											...
											if ($discription == "") {
												$comment_disp = "commented on your Upamoja";
												$posted_pic = "";
											}else {
												$comment_disp = "commented on yourUpamoja photo";
												$posted_pic = "userdata/daowat_pics/".$discription;
											}
											if ($discription == "") {
												$comment_disp = "commented on your Upamoja";
											}else {
												$comment_disp = "commented on your Upamoja photo";
											}
