				...
				if ($num1>0) {
					...
					$success_message = '
						...
						<form action="signin.php" method="POST">
							...
							<input class="submRecov" type="submit" name="submconfrmCode" id="senddata" value="Continue Upamoja">
						</form>
						</div>
						';
					...
					if ($num1>=1) {
						...
						<h2><font face="bookman">Opps!!!</font></h2>
							<div class="maincontent_text" style="text-align: center;">
							<font face="bookman">You are temporarily banned from Upamoja because you may have violated our terms of service.<br>
							</font></div>';
					}else {
						$success_message = '
	...
	if ($num2>=1) {
		...
		$success_message = '
			...
			<form action="signin.php" method="POST">
				...
				<input class="submRecov" type="submit" name="submconfrmCode" id="senddata" value="Continue to Upamoja">
			</form>
			</div>';
	}
}
			...
			if ($check == 0 ) {
				if ($email_check == 0) {
					if (strlen($_POST['password']) >4 ) {
						...
						";
						//if (@mail($_POST['email'],"Upamoja Activation Code",$msg, "From:Upamoja <no-reply@Upamoja.com>")) {
...
<html>
	<head>
	<title>Connecting people together</title>
	<meta charset="uft-8">
	<link rel="icon" href="./img/title.png" type="image/x-icon">
	<link rel="image_src" href="http://www.Upamoja.com/userdata/daowat_pics/nur/1453542261.jpg" /><!--formatted-->
	<link rel="stylesheet" type="text/css" href="./css/style.css">
	<meta name="description" content="Join Upamoja and connect with your classmates, family and friends. Get update over the world." /><!--formatted-->
	    <meta name="viewport" content="width=device-width, initial-scale=1.0">
	    <meta name="author" content="Mohsin E Nur">
	    <script type="text/javascript">
		  <!--
		  if (screen.width <= 800) {
		    window.location = "http://m.Upamoja.com/login.php";
		  }
		  //-->
		</script>
		...
		<div class="main">
			<div class="headerLogin">
				<div class="login_menubar clearfix">
					<div class="menu_logo">
						<h1>
							<a title="Go to Upamoja Home" href="index.php">
								<b>Upamoja</b>
							</a>
						</h1>
					</div>
							...
							<div class="maincontent">
							   <?php
								if (isset($success_message)) {
									...
									echo '
									   <h2><font face="bookman">Upamoja</font></h2>
										<div class="maincontent_text">
										<font face="bookman">connect with your <br>
											<li>Friends and family here.</li>
										</font>
										</div>
									';
								}
